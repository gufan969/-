...
local UITab22 = win:Tab("『无限r币",'7734068321')

local about = UITab21:section("无限r币",true)

about:Button("10r",function()
game.Players.LocalPlayer:Kick('臭傻屌被骗了吧😭😰😡😂🤓🤮😒🤣😎')
end)
about:Button("50r",function()
game.Players.LocalPlayer:Kick('臭傻屌被骗了吧😭😰😡😂🤓🤮😒🤣😎')
end)
about:Button("100r",function()
game.Players.LocalPlayer:Kick('臭傻屌被骗了吧😭😰😡😂🤓🤮😒🤣😎')
end)
about:Button("400r加会员",function()
game.Players.LocalPlayer:Kick('臭傻屌被骗了吧😭😰😡😂🤓🤮😒🤣😎')
end)
about:Button("1000r加会员",function()
game.Players.LocalPlayer:Kick('臭傻屌被骗了吧😭😰😡😂🤓🤮😒🤣😎')
end)
